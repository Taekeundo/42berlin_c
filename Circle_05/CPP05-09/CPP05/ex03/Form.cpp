...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/20 10:39:53 by tkwak             #+#    #+#             */
/*   Updated: 2025/03/20 10:39:53 by tkwak            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Form::checkExecution(const Bureaucrat& executingBureaucrat) const
{
    if (!getIsSigned())
        throw NotSignedException();
    if (executingBureaucrat.getGrade() > execGrade)
        throw GradeTooHighException();
}
...
const char* Form::FailToOpenFileException::what(void) const throw()
{
