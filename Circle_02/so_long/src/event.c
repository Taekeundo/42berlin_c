...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/31 18:47:08 by tkwak             #+#    #+#             */
/*   Updated: 2023/10/31 18:47:10 by tkwak            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	key_hook(mlx_key_data_t keydata, void *param)
{
	...
	game = param;
	y = &game->img.player.front.image->instances[0].y;
	x = &game->img.player.front.image->instances[0].x;
